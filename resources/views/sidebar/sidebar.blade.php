        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu ">
                    ...
                    <ul>
                        <li><a href="{{ route('home') }}" class=" @if (\Request::is('home')) active @endif">Admin Dashboard</a></li>

                        {{-- <li><a href="{{ route('teacher/dashboard') }}" class=" @if (\Request::is('teacher/dashboard')) active @endif">Teacher Dashboard</a>
                </li>

                <li><a href="{{ route('student/dashboard') }}" class=" @if (\Request::is('student/dashboard')) active @endif">Student Dashboard</a></li> --}}
            </ul>
            </li>
            ...
            <li class="submenu ">
                ...
                <ul>
                    <li><a href="{{ route ('listarusuarios') }}" class=" @if (\Request::is('listarusuarios')) active @endif">Usuarios</a></li>
                </ul>
            </li>
